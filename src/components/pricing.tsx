...
//   return (
//     <div className="font-sans md:font-serif animate-fadeIn">
//       <div className="text-4xl font-bold text-center mb-6 text-gray-900 animate-slideDown">
//         Pick Your Perfect Plan
//       </div>
//       <div className="text-xl text-gray-500 text-center m-2 px-4 md:px-16 animate-slideUp">
...
//       <div className="container mx-auto px-4 py-4 pb-0 text-3xl text-center font-bold text-purple-600 animate-fadeIn">
//         Pricing Plans
...
//                 }
//                 text-white font-bold rounded-lg transition-colors duration-200 transform hover:scale-105`}
//               >
//                 Choose Plan
//               </button>
//             </div>
...
//       <div className="flex flex-col sm:flex-row justify-center gap-5 mt-8 px-4 animate-slideUp">
//         <button
//           className="group bg-gradient-to-r from-blue-500 to-blue-700 text-white px-8 py-3 rounded-lg text-lg font-semibold
//           transition-all duration-300 hover:shadow-lg transform hover:scale-105 mb-4 sm:mb-0"
//         >
//           <a
...
//         </button>
//         <button
//           className="group bg-gradient-to-r from-purple-500 to-purple-700 text-white px-8 py-3 rounded-lg text-lg font-semibold
...
export default function Pricing() {
  ...
  return (
    <div className="font-sans md:font-serif animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-5 mt-8 px-4 animate-fade-up">
        <button
